...
public class PhotonManager : Photon.MonoBehaviour {
	...
	void OnJoinedRoom() {
		...
		GameObject.Find ("LeaveRoomB").GetComponent<Button> ().interactable = true;
	}
	...
	public void OnLeaveRoom(){
		...
		//ボタンを押せるようにする
		GameObject.Find ("LeaveRoomB").GetComponent<Button> ().interactable = false;
	}
	...
	public void ChangeVal2(){
		cube.GetComponent<CubeScript> ().hensu2 = 5f;
	}
